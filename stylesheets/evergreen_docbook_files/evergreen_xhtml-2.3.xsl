...
<!-- customized header, to add home link -->
  ...
  <!-- custom footer for Evergreen copyright --> 
    ...
    <xsl:template name="user.footer.navigation">        
       <div style="float: left; vertical-align: top;"><p style="font-style:
italic; font-size: .8em; vertical-align: top;">Report any errors in this
documentation using <a href="https://bugs.launchpad.net/evergreen/+filebug">Launchpad</a>.<br />Documentation for Evergreen version 2.3 <br/>Copyright © 2007-2012, 
